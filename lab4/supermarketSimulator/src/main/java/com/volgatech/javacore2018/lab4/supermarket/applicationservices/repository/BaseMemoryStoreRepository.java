...
public abstract class BaseMemoryStoreRepository implements StoreRepository {
    ...
    protected BaseMemoryStoreRepository() {
    }
    ...
    @Override
    public BaseProduct takeProduct(Integer productId, Integer count) throws NotFoundProductException {
    ...
    @Override
    public boolean isUnknownProduct(BaseProduct product) {
