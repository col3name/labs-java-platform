...
public class CountableProductTest extends ExceptionTest {
    ...
    public void invalidId() throws InvalidModelException {
        ...
        new CountableProduct(-1, "sas", Adult.MIN_AGE, BigDecimal.valueOf(90.0), BigDecimal.valueOf(0.0));
    }

    @Test
    public void invalidName() throws InvalidModelException {
        exceptException(InvalidModelException.class, "name min length 3");
        new CountableProduct(1, "as", Adult.MIN_AGE, BigDecimal.valueOf(90.0), BigDecimal.valueOf(0.0));
    }
    ...
    public void invalidMinAge() throws InvalidModelException {
        ...
        new CountableProduct(1, "SSD", -10, BigDecimal.valueOf(90.0), BigDecimal.valueOf(0.0));
    }
    ...
    public void invalidPrice() throws InvalidModelException {
        ...
        new CountableProduct(1, "SSD", 1, BigDecimal.valueOf(-90.0), BigDecimal.valueOf(0.0));
    }
    ...
    public void invalidBonus() throws InvalidModelException {
        ...
        new CountableProduct(1, "SSD", 10, BigDecimal.valueOf(90.0), BigDecimal.valueOf(-10.0));
    }
    ...
    public void validTest() throws InvalidModelException {
        ...
        CountableProduct product1 = new CountableProduct(id, name, ageLimit, price, bonus);
        assertEquals(product, product1);
    }
}